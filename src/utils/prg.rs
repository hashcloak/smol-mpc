/// Implementation of a PRG based on AES-CTR. The idea is that a pseudo-random
/// block of bits is generated by computing
///             block = AES(seed, current_counter)
/// where current_counter = PRG_NONCE || counter, and counter is increased when
...
impl Prg {
    ...
    /// Creates a new PRG. The seed can be provided or generated by default
    /// filled with zeros. If a key is provided, then there are two cases. If
